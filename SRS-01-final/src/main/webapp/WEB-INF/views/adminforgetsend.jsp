...
<%
    ...
    String sql = "update admin set OTP='"+n+"' where Mail='"+request.getParameter("t1")+"'";
    ...
    session.setAttribute("returnpage","adminpwdotp.jsp");
    response.sendRedirect("adminsentmail.jsp");
